...
{
    std::stringstream ss;
    ss << std::setfill('0') << std::setw(2) << hour << ":" << std::setfill('0')
       << std::setw(2) << minute << ":" << std::setfill('0') << std::setw(2)
       << second;
    return ss.str();
}
...
auto main() -> int
{
    ...
    std::cout << "#time_to_midnight()"
              << "\n";
    std::cout << t.time_to_midnight(t).to_string() << " "
              << "to midnight"
              << "\n"
              << "\n";
    // operator+
